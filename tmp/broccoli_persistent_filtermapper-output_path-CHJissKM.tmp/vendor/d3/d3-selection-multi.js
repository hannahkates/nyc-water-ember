...
})((function(){ function newDefine(){ var args = Array.prototype.slice.call(arguments); args.unshift("d3-selection-multi"); return define.apply(null, args); }; newDefine.amd = true; return newDefine; })());