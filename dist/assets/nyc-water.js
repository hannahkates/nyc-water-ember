...
define('nyc-water/components/bar-chart-2', ['exports', 'd3'], function (exports, _d) {
  ...
  exports.default = Ember.Component.extend({
    ...
    didInsertElement: function () {
      ...
      var svg2 = _d.default.select("h3").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
...
define('nyc-water/components/bar-chart-3', ['exports', 'd3'], function (exports, _d) {
  ...
  exports.default = Ember.Component.extend({
    ...
    didInsertElement: function () {
      ...
      var svg3 = _d.default.select("h3").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
...
define('nyc-water/components/bar-chart', ['exports', 'd3'], function (exports, _d) {
  ...
  exports.default = Ember.Component.extend({
    ...
    didInsertElement: function () {
      ...
      // add the SVG element
      var svg = _d.default.select("h1").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
...
if (!runningTests) {
  require("nyc-water/app")["default"].create({"name":"nyc-water","version":"0.0.0+e80e359c"});
}
